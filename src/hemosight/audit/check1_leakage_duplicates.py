...
PROVENANCE. Phase 1, Task 2 (scripts/participant_overlap_check_phase1.py). That check found 419 MD5
...
PROVENANCE = ("Phase 1 Task 2 - the CP-AnemiC / Ghana overlap check "
              "(scripts/participant_overlap_check_phase1.py, DECISION LOG 2026-09-11)")
