...
PROVENANCE. Phase 4, Task 3 (scripts/phase4_gate_b.py, DECISION LOG 2026-09-11 "TASK 3
...
PROVENANCE = ("Phase 4 Task 3 - sex alone beat the PPG model by 30% "
              "(scripts/phase4_gate_b.py, RESULTS LOG 2026-09-11)")
...
def run(inp: AuditInput, thresholds: dict | None = None,
    ...
    with Timer() as t:
        ...
        # scripts/phase6_validate_harness.py flipped this check on 2 of 20 seeds, and
