...
```powershell
.\.venv\Scripts\python.exe scripts\phase1_manifests.py          # manifests
.\.venv\Scripts\python.exe scripts\phase1_overlap.py            # hashes + embeddings
.\.venv\Scripts\python.exe scripts\phase1_figures.py            # -> reports/figures/
```

| Figure | Produced by | Depends on |
| --- | --- | --- |
| `phase1_overlap_cp_anemic__ghana_conj.png` | `scripts/phase1_figures.py` | `data/interim/overlap/hashes_*.csv` |
| `phase1_cp_anemic_label_conflict.png` | `scripts/phase1_figures.py` | hashes + `manifests/cp_anemic.csv` |
| `phase1_hb_distributions.png` | `scripts/phase1_figures.py` | `manifests/master.csv` |
| `phase1_overlap_*__ghana_nail.png` | `scripts/phase1_overlap.py` | hashes + embeddings |

`scripts/phase1_overlap.py` caches hashes and embeddings under
