...
empirical floor use `scripts/phase5_perm_extended.py`, which checkpoints and resumes;
test B below is the n=60 version already on record.

    .\\.venv\\Scripts\\python.exe scripts\\phase5_harden.py [--perms 200] [--sel-perms 60]
"""
