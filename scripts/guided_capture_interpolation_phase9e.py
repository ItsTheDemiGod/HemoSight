...
not doing the work.
    ...
    .\\.venv\\Scripts\\python.exe scripts\\guided_capture_interpolation_phase9e.py
"""
...
def main() -> int:
    ...
    if not cache.exists():
        print(f"  MISSING {cache} - run scripts/parameter_uncertainty_propagation_phase9c.py first")
        return 1
    z = np.load(cache)
