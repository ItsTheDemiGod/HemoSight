...
and how long the remainder should take at the observed rate.
    ...
    .\\.venv\\Scripts\\python.exe scripts\\permutation_run_status_phase5.py [--target 240]
"""
...
from permutation_extended_run_phase5 import JSONL, read_checkpoint, summarise
