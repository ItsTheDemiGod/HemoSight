...
Pre-declared in CLAUDE.md (Phase 9E, 2026-09-21) before this ran:
  ...
  * Phase 9D's MDEs must reproduce before any new number is computed.
    ...
    .\\.venv\\Scripts\\python.exe scripts\\phase9e_required_n.py
"""
...
from phase9a_screening import (IMG_PRED, PPG_DEEP, PPG_FEAT,  # noqa: E402
                               XS_PRED, folds_for, ridge_cv)
from phase9d_power import (paired_auroc_replicates,      # noqa: E402
