...
model-independent measures:
  ...
  3. A permutation test - shuffle Hb across subjects, refit, and build the null
    ...
    .\\.venv\\Scripts\\python.exe scripts\\ppg_ceiling_analysis_phase4_5.py [--perms 500]
"""
...
# drift apart - the reason scripts/permutation_hardening_phase5.py imports its CV driver from
